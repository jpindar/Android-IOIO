...
public class SimpleDigitalOutputActivity extends AbstractIOIOActivity implements OnClickListener {
	...
	class IOIOThread extends AbstractIOIOActivity.IOIOThread {
		...
		public void pulse() throws ConnectionLostException{
			mLed1.write(true);mLed1.write(false);			
		}
		
		public void sendToLED(int red, int green, int blue)throws ConnectionLostException {
			int i;
			for(i=0; i<8; i++) {
				mLed2.write(true); mLed1.write(true);mLed1.write(false);
			}
			for(i=0; i<8; i++) {
				mLed2.write(false); mLed1.write(true);mLed1.write(false);
			}
			for(i=0; i<8; i++) {
				mLed2.write(false); mLed1.write(true);mLed1.write(false);
			}
		}
		public void setStrip() throws ConnectionLostException{
			int i;
			mLed2.write(false);
			mLed1.write(false);
